    ...
    if (this.state.savedArticles == "") {
      return(
        <li className="list-group-item">
          <h3>
              <span><em>Doesn't look like you don't have anything saved yet!</em></span>
          </h3>
        </li>
      )
    }
              ...
              <li className="list-group-item" >
                <h3>
                  ...
                  <span className="btn-group pull-right" >
                    <a href={article.url} target="_blank"><button className="btn btn-default ">View this Article</button></a>
                    <button className="btn btn-primary" onClick={this.handleClick.bind(this, article)}>Remove this Article</button>
                  </span>
                </h3>
