              ...
              <li className="list-group-item" >
                <h3>
                    ...
                    <span className="btn-group pull-right" >
                      <a href={article.url} target="_blank"><button className="btn btn-default ">View the Article</button></a>
                      <button className="btn btn-primary" onClick={this.handleClick.bind(this, article)}>Delete the Article</button>
                    </span>
                </h3>
